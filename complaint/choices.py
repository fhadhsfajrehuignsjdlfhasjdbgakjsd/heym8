THEMES_TO_COMPLAIN_ON_NOTE = (
    ('ext_drugs_prop', 'Explicit extremism/drugs propaganda'),#complaint on this theme can be sent towards
    ...
    ('suic_call', 'Suicide call'),#complaint on this theme can be sent towards
    #photo, video, thought and news. Number of signifacant complaints is based on number of mates+receivedRequests(thoughts) or number of members(News)
    #Before community has 1000 members sig.number=300, after sig.number=30% of members
    #Before user has 200 m+rq sig.number=65, after sig.number=25% of m+rq
    #banning comes after 2 news have obtained sig.number of complaints
    ...
    ('discredit', 'Discredit users because of their nationality, gender and religion'),#complaint on this theme can be sent towards
    #photo, video thought and news. Number of signifacant complaints is based on number of mates+receivedRequests(thoughts) or number of members(News)
    #Before community has 1000 members sig.number=300, after sig.number=30% of members
    #Before user has 200 m+rq sig.number=65, after sig.number=25% of m+rq
    #banning comes after 2 news have obtained sig.number of complaints
    ...
    ('adult_cont', 'Spreading adult content'),#complaint on this theme can be sent towards
    #photo, video thought and news. Number of signifacant complaints is based on number of mates+receivedRequests(thoughts) or number of members(News)
    #Before community has 1000 members sig.number=300, after sig.number=30% of members
    #Before user has 200 m+rq sig.number=65, after sig.number=25% of m+rq
    #banning comes after 2 news have obtained sig.number of complaints
...
THEMES_TO_COMPLAIN_ON_MESSAGE = (
    ('spm', 'Sending spam'),#complaint can be sent only towards message
